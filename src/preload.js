...
const api = {
  ...
  beginRowResize: () => ipcRenderer.send('bubble:row-resize-start'),
  moveRowResize: () => ipcRenderer.send('bubble:row-resize-move'),
  endRowResize: () => ipcRenderer.send('bubble:row-resize-end'),
  reportBubbleMetrics: (metrics) => ipcRenderer.send('bubble:metrics', metrics),
